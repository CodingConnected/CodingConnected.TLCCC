...
#define CIF_DET_ONDERGEDRAG 8 /* detectie ondergedrag */ /* CIF_GPS [ ] en CIF_WPS [ ] */ 
#define CIF_PROG_STATUS     0 /* CIF_GPS en CIF_WPS programmastatus buffer */ 
#define CIF_PROG_FOUT       1 /* CIF_GPS en CIF_WPS programma-foutbuffer */
...
#define CIF_GEEN_FOUT 0 /* geldt ook voor CIF_WPS [CIF_PROG_FOUT] en return-waarde applicatieprogramma() */ 
#define CIF_FB_FOUT   1 /* fasebewaking */ 
#define CIF_AP_FOUT2  2 /* procesbesturing wacht te lang met lezen van door het applicatie-programma geschreven informatie */ 
#define CIF_AP_FOUT3  4 /* applicatieprogramma leest een niet gedefinieerde code */ 

/* CIF_WPS [CIF_PROG_FOUT] */ 
#define CIF_PB_FOUT1 1 /* werkelijke uitgangssturing te lang ongelijk aan gewenste uitgangs-sturing */ 
#define CIF_PB_FOUT2 2 /* applicatieprogramma wacht te lang met lezen van door de proces-besturing geschreven informatie */ 
#define CIF_PB_FOUT3 4 /* procesbesturing leest een niet gedefinieerde code */ 
...
#define CIF_INIT_PARM     -3 /* initiele waarden in parameterbuffer aanroep en returnwaarde applicatieprogramma() */ 
...
/*  
CIF_DSI *//* codering van de elementen */ 
/* ------------------------- */ 
